  ...
  args0: [
    ...
    },
    {
      ...
      options: [
        ...
        ['creation timestamp', 'CREATED_TIMESTAMP'],
        ['creator', 'CREATOR'],
        ['creator ID', 'CREATOR_ID'],
        ['description', 'DESCRIPTION'],
        ['entity ID', 'ENTITY_ID'],
        ['entity metadata', 'METADATA'],
        ['enity type', 'ENTITY_TYPE'],
        ['guild', 'GUILD'],
        ['guild ID', 'GUILD_ID'],
        ['ID', 'ID'],
        ['image', 'IMAGE'],
        ...
        ['schedule end', 'END'],
        ["schedule's end timestamp", 'END_TIMESTAMP'],
        ['schedule start', 'START'],
        ["schedule's start timestamp", 'START_TIMESTAMP'],
        ['status', 'STATUS'],
        ['url', 'URL'],
...
registerRestrictions(blockName, [
  {
    ...
    types: ['lime_guild_sheduled_events_create', 'lime_guild_sheduled_events_remove']
  }
]);
