...
displayable.if = convertBlocklyHTMLElementToDisplayableContent(
...
displayable.msgrecieved = convertBlocklyHTMLElementToDisplayableContent(
...
displayable.bool = convertBlocklyHTMLElementToDisplayableContent(
